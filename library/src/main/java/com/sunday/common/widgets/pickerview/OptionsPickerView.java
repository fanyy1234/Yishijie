...
import com.sunday.common.widgets.pickerview.view.WheelOptions;
...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public interface OnOptionsSelectListener {
         void onOptionsSelect(OptionsPickerView optionsPickerView,int options1, int option2, int options3);
    }
