...
import com.bby.yishijie.member.adapter.IndexTodaysAdapter;
import com.bby.yishijie.member.adapter.LimitTimePageAdapter;
import com.bby.yishijie.member.adapter.LimitTimeTabAdapter;
...
public class TodayFragment extends BaseLazyFragment {
    ...
    private void getHeadData() {
        Call<ResultDO<IndexAd>> call = ApiClient.getApiAdapter().getAdveList();
...
//                    getLimitTimeList();
    ...
    private void getProducts() {
        Call<ResultDO<LimitProduct>> call = ApiClient.getApiAdapter().getLimitTimeProList(timeLimitId);
