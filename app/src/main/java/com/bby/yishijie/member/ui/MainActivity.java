...
public class MainActivity extends BaseActivity {
    ...
    private void checkLogin() {
        ...
        if (!login) {
            ...
            if (isShop){
                com.bby.yishijie.shop.entity.Member member1 = null;
                try {
                    member1 = (com.bby.yishijie.shop.entity.Member) SharePerferenceUtils.getIns(mContext).getOAuth();
                } catch (Exception e) {
                    e.printStackTrace();
                }
                if (member1 != null) {
    ...
    protected void onResume() {
        ...
        if (isShop){
            ...
            try {
                ...
                member = com.bby.yishijie.shop.entity.Member.transferMember((com.bby.yishijie.shop.entity.Member) SharePerferenceUtils.getIns(mContext).getOAuth());
            }
            if (member != null) {
                BaseApp.getInstance().setMember(member);
