...
import com.bby.yishijie.member.adapter.IndexProductListAdapter;
...
public class IndexClasssifyFragment extends BaseLazyFragment {
    ...
    private IndexProductListAdapter adapter;
    private long memberId;
    private String parentName;

    public static IndexClasssifyFragment newInstance(long pCatId,String parentName) {
        IndexClasssifyFragment fragment = new IndexClasssifyFragment();
    ...
    private void initRefreshLayout() {
        ...
        adapter = new IndexProductListAdapter(mContext, dataSet, productClassifyList,parentName,pCatId);
    ...
    private void getData() {
        Call<ResultDO<List<Product>>> call= ApiClient.getApiAdapter().getProductList(1,0,null,
