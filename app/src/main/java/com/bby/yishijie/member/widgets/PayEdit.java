...
public class PayEdit extends EditText {
    ...
    public PayEdit(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PayEdit(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        bgColor = typedArray.getColor(R.styleable.PwdEditText_backgroundColor, Color.WHITE);
    ...
    private void drawBorder(Canvas canvas) {
        //绘制背景
        canvas.drawRoundRect(new RectF(0, 0, mWidth, mHeight), borderCornerRadius, borderCornerRadius, bgPaint);
        //绘制边框
        canvas.drawRoundRect(new RectF(0, 0, mWidth, mHeight), borderCornerRadius, borderCornerRadius, borderPaint);
    }
