    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            ...
            case TYPE_LIST:
                ...
                productHolder.priceOld.setText(String.format("赚%s", item.getScale().setScale(2, RoundingMode.HALF_UP)));
            ...
            switch (v.getId()) {
                ...
                case R.id.btn_share:
                    ...
                    ShareWindow shareWindow = new ShareWindow(mContext, shareUrl, item2.getName(), item2.getDetailImage(),
                            ...
                            mContext.getResources().getString(R.string.share_product_desc), String.format("%s", item2.getCurrentPrice().setScale(2, RoundingMode.HALF_UP)),item2.getShareImage());
