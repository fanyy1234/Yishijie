...
public class OrderListFragment extends BaseFragment {
    ...
    private int pageNo = 1, lastVisibleItem,type;
    ...
    public static OrderListFragment newInstance(int status,int type) {
    ...
    private void getOrderPay(long orderId) {
        Call<ResultDO<Order>> call = ApiClient.getApiAdapter().getOrderPay2(orderId);
    ...
    private void getOrderList() {
        Call<ResultDO<List<Order>>> call = ApiClient.getApiAdapter().getOrderListNew(memberId,
                status, pageNo, Constants.PAGE_SIZE, 2,2);
